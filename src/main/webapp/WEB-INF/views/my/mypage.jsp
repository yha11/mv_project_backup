...
<%@ include file="../ui/nav.jsp" %>
	...
	<div class="card text-center" style="width: 650px; margin: 30px auto 0px auto;">
	  ...
	  <div class="card-footer text-muted">
	    <ul class="nav justify-content-center">
		  <li class="nav-item">
		    <a class="nav-link active" aria-current="page" href="paymentHistory">MY 리뷰</a>
		  </li>
		  <li class="nav-item">
		    <a class="nav-link" href="#">무비로그</a>
		  </li>
		  <li class="nav-item">
		    <a class="nav-link" href="#">1:1 문의</a>
		  </li>
		  <li class="nav-item">
		    <a class="nav-link" href="#">정보 관리</a>
		  </li>
		</ul>
	  </div>
	</div>
